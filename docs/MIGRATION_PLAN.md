...
| # | タスク | 詳細 | 見積 |
|---|--------|------|------|
| 1-1 | プロジェクト構造作成 | `docs/` ディレクトリと基本ファイル | 15分 |
| 1-2 | HTML + Tailwind セットアップ | 基本レイアウト、ダークテーマ | 30分 |
| 1-3 | 定数定義 (`constants.js`) | Solfege, Relative, Note クラス相当 | 30分 |
| 1-4 | 状態管理 (`state.js`) | QuestionNotifier 相当の状態管理 | 45分 |
